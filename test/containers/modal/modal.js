		...
		events: {		
			...
			initialize: function (options) {
				this.options = _.extend({
						...
						escape: true,
						animate: false,
						template: _.template($('#modalTmp').html()),
...
(function(global){
	...
	global.DialogConstruct = function(obj){
		Ctor.call(this, obj);
		this.name = obj;
		return {}
	};
	
	global.DialogConstruct.prototype = Object.create(Ctor.prototype, {		
		constructor : {
			value : global.DialogConstruct,
			writeable : true,
			configurable : true,
			enumerable : true
		}		
	...
	function Dialog(obj){
        global.DialogConstruct.call(this, arguments);
		if(obj instanceof Dialog) return obj;
		if(!(this instanceof Dialog)) return new Dialog(obj);
    };
    
	Dialog.prototype = Object.create(global.DialogConstruct.prototype, {		
		constructor : {
			value : global.Dialog,
			writeable : true,
			configurable : true,
